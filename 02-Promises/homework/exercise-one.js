...
function problemA () {
  ...
  //   setTimeout( () => {
  //     resolve(readFile('poem-one/stanza-01.txt'), function(error, lecture) {
  //       blue(lecture)
  //     })
  //   })
  // })
...
function problemB () {
  ...
  // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-01.txt').then((poema1) => {
    blue(poema1)
    })
    promisifiedReadFile('poem-one/stanza-03.txt').then((poema3) => {
      blue(poema3)
      })
  promisifiedReadFile('poem-one/stanza-02.txt').then((poema2) => {
    blue(poema2)
    })
...
function problemD () {
  ...
  // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-04.txt').then((poema2) => {
    blue(poema2)}, error => {
